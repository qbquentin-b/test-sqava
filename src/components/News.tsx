        ...
        <div className="bg-white rounded-xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Formation continue</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Travail en équipe</h4>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Qualité des soins</h4>
              <p className="text-gray-600">
